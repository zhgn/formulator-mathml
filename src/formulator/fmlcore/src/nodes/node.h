...
class __YUNEN_FORMULIB__ CNode : public CNodeInfo
{
protected:
...
class __YUNEN_FORMULIB__ CParentNode : public CNode
{
private:
...
class __YUNEN_FORMULIB__ CPlaneText
	: public CNode
	, public CNodeExInfo
{
protected:
...
class __YUNEN_FORMULIB__ CLineNode 
	: public CParentNode
{
protected:
...
class __YUNEN_FORMULIB__ CFrameNode 
	: public CParentNode
{
protected:
...
class __YUNEN_FORMULIB__ CFormulaNode
	: public CParentNode
	, public CNodeExInfo
...
__YUNEN_FORMULIB__ RealFde calculateCurrentHeight( CNode *pNode, int ignoreIndent, long level, RealFde ascent );
__YUNEN_FORMULIB__ RealFde calculateCurrentDepth( long level, RealFde ascent );
__YUNEN_FORMULIB__ RealFde calculateCurrentTextAscent( long level );
__YUNEN_FORMULIB__ RealFde calculateCurrentTextDescent( long level );

__YUNEN_FORMULIB__ void _CM_apply_readApplyOperator( CParentNode *node, QString& out, long level, QString *opTagSeparated = 0 );
__YUNEN_FORMULIB__ void _CM_apply_returnBackApplyOperator( CParentNode *node );
__YUNEN_FORMULIB__ void getMMultiscriptsAttr( long nChildCoded, QString& buttonID, long& base, long& sw, long& nw, long& se, long& ne );

//=== NODE TREE ITERATORS
__YUNEN_FORMULIB__ void mmlTreeIterator__mapUnicodeValue2EntityName( AST_TXML_Node *node, void *data );
