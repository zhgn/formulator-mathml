    ...
    : QWidget(parent)
{
    ...
    QLabel *m_isForceMathMLLabel = new QLabel( QString(
        ...
        "attributes instead of current font and color settings of editor抯 styles.</p>").arg(__page_isbold).arg(__page_remarkBackground.name()));
    ...
    : QWidget(parent)
{
    ...
    m_isUpdate = new QCheckBox("Allow automatic update requests (http://www.yunentech.com)");
