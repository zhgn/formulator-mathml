...
void QFormulatorEditWindow::initEditToolbar( QMainWindow *uiUpdater )
{
    ...
    uiUpdater->addToolBar(Qt::LeftToolBarArea, editToolBar);
...
{
    insertToolBar = new QToolBar(tr("Insert"));
    ...
    insertToolBar->setAllowedAreas(Qt::LeftToolBarArea);
    insertToolBar->setMovable(false);
    uiUpdater->addToolBar(Qt::LeftToolBarArea, insertToolBar);
...
void QFormulatorEditWindow::initXmlBtnGui( QMainWindow *uiUpdater )
{
    ...
    for( long t = 1; t < ::getCurrentToolBarSet()->getToolBarCount(); t++ )
    {
        ...
        {
            toolbarItem = uiUpdater->addToolBar(groupName);
            toolbarItem->setMovable(false);

            toolbarGroups.insert(groupName, toolbarItem);
