...
class __YUNEN_FORMULIB__ FBAST_Node
{
protected:
...
class __YUNEN_FORMULIB__ FBAST_Expr : public FBAST_Node
{
public:
...
class __YUNEN_FORMULIB__ FBAST_Variable : public FBAST_Node
{
public:
	QString var_name;
	QString parent_name;
...
class __YUNEN_FORMULIB__ FBAST_Assign : public FBAST_Node
{
public:
	FBAST_Variable *left;
	FBAST_Expr *right;
...
class __YUNEN_FORMULIB__ FBAST_Value : public FBAST_Node
{
public:
	int is_integer;
	union
...
class __YUNEN_FORMULIB__ FBAST_Function : public FBAST_Node
{
public:
...
class __YUNEN_FORMULIB__ FBAST_Compound : public FBAST_Node
{
public:
